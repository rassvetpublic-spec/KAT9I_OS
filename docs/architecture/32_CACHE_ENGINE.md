# 32. CacheEngine — высокопроизводительный кэш KAT9I_OS
...
## 32.4. Spill на диск только при memory pressure
...
## 32.7. Примеры допустимых данных
...
## 32.8. Детерминированный CacheKey
...
## 32.10. Версионированный протокол
...
## 32.16. Простота первой реализации
...
## 32.17. Будущая совместимость без обязательной реализации
...
## 32.20. Fail-open и degraded mode
...
## 32.23. Benchmark-first для усложнений
...
## 32.25. Главный критерий качества
