# Карта архитектурной ответственности модулей KAT9I_OS (Навигационный индекс)

> [!IMPORTANT]
> **Единый источник истины (SSoT):**
> Каноническим источником архитектурной ответственности модулей, контрактов и системных инвариантов является:
> **[27. Реестр модулей и карта ответственности KAT9I_OS](27_MODULE_REGISTRY_AND_RESPONSIBILITY_MAP.md)**.
> Настоящий документ представляет собой краткий навигационный индекс и сводку соответствия модулей для коворкеров и сервисного механизма `.github/CODEOWNERS`.

---

## 1. Назначение документа

Настоящий производный документ фиксирует соответствие доменов, архитектурных разделов и ответственных в соответствии с каноническим разделом [27_MODULE_REGISTRY_AND_RESPONSIBILITY_MAP.md](27_MODULE_REGISTRY_AND_RESPONSIBILITY_MAP.md).

> **Ключевой инвариант:**
> Архитектурная ответственность за модуль и механизм автоматического назначения review (`.github/CODEOWNERS`) строго разделены:
> 1. Архитектурная карта ([Раздел 27](27_MODULE_REGISTRY_AND_RESPONSIBILITY_MAP.md)) определяет, кто проектирует модуль, отвечает за его инварианты и целостность контрактов.
...
3. **Разрешение конфликтов:**
   - При любых изменениях, затрагивающих несколько модулей, приоритет имеют инварианты Безопасности и Ядра (`Core`, `Rules`, `Security`), зафиксированные в [Разделе 27](27_MODULE_REGISTRY_AND_RESPONSIBILITY_MAP.md).