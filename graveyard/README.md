...
Сейчас manifest содержит шесть исторических снимков: четыре bootstrap-архива от 2026-09-09, отдельный DATA-only аудит полезных остатков закрытого PR #86 от 2026-09-10 и DATA-only снимок отложенных доноров Ai2Local для KAT9I_OS от 2026-09-13. Их содержимое может намеренно содержать устаревшие правила или статусы и не является CONTROL.
