<#
.SYNOPSIS
    Утилита кастомизации интерфейса Antigravity Standalone (Electron UI).

.DESCRIPTION
    Внедряет контекстное меню по правой кнопке мыши (буфер обмена, перенос текста в чат,
    вызов скилов, модалка настроек) и визуальный эффект матрицы (Digital Rain, Stacking, Liquid Flow).
    Поддерживает режимы:
